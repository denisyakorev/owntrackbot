...
class BotTestCase(TestCase):
	...
	def test_message_out(self):
		...
		equals = [
			...
			['+1h23m #newtask',['update', 'error_task_does_not_exists']],

			['+1h23m #existingtask',['update', 'error_task_does_not_exists']],

			['?1h23m #existingtask',['read', 'task_existingtask']],

			['23m #existingtask',['read', 'add 23 min to task1']],

			['23 #existingtask',['read', 'error_unknown_command']],

			['m #existingtask',['read', 'error_unknown_command']],
